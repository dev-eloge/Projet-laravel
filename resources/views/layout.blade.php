		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto mb-2 mb-lg-0">
					...
					<li class="nav-item "> <a class="nav-link" href="how-it-works.php">How It Works</a>
					</li>
					...
					<li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Pages</a>
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item " href="blog-details.php">Blog Details</a>
							</li>
							<li><a class="dropdown-item " href="service-details.php">Service Details</a>
							</li>
							<li><a class="dropdown-item " href="faq.php">FAQ&#39;s</a>
							</li>
							<li><a class="dropdown-item " href="legal.php">Legal</a>
							</li>
							<li><a class="dropdown-item " href="terms.php">Terms &amp; Condition</a>
							</li>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 service-item">
        <a class="text-black" href="service-details.php">
